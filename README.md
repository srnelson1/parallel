...
To start, begin by running watch_dir.py in bin/. Job's are submitted by placing the job's file in jobs/. Any errors corresponding to a particular job are placed in errors/. Job outputs go in outputs/.
