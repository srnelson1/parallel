...
class JobConfig():
    def __init__(self, job_submission_path=None, root_dir=None, submission_name=None, file_path=None, lang=None, walltime=None, has_output=None):
...
class JobSubmission():
    def __init__(self, job_submission_path, root_dir):
